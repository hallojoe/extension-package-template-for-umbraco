...
1. Create a site with [`src/new-extention-package-for-umbraco.ps1`](new-extention-package-for-umbraco.ps1).
2. Make changes in the generated site until the template behavior is improved.
3. Sync those changes back into the template with [`src/sync-project-to-templates.ps1`](sync-project-to-templates.ps1).

## Key Scripts

- [Script Docs](README.md)
- [new-extention-package-for-umbraco.ps1](new-extention-package-for-umbraco.ps1)
- [sync-project-to-templates.ps1](sync-project-to-templates.ps1)
- [create-packaged-template.ps1](create-packaged-template.ps1)
- [generate-dotnet-template.ps1](generate-dotnet-template.ps1)
- [pack-dotnet-template.ps1](pack-dotnet-template.ps1)
