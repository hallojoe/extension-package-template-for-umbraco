...
$tokenPairs = @(
    ...
    [pscustomobject]@{ Source = $serviceName; Target = "__TEMPLATE_SERVICE_NAME__" },
    [pscustomobject]@{ Source = $workspaceContextConstant; Target = "__TEMPLATE_WORKSPACE_CONTEXT_CONSTANT__" },
    [pscustomobject]@{ Source = $workspaceContextClass; Target = "__TEMPLATE_WORKSPACE_CONTEXT_CLASS__" },
    [pscustomobject]@{ Source = $workspaceDataSourceClass; Target = "__TEMPLATE_WORKSPACE_DATASOURCE_CLASS__" },
    [pscustomobject]@{ Source = $workspaceRepositoryClass; Target = "__TEMPLATE_WORKSPACE_REPOSITORY_CLASS__" },
    [pscustomobject]@{ Source = $dataSourceInterface; Target = "__TEMPLATE_DATASOURCE_INTERFACE__" },
